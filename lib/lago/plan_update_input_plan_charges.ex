defmodule Lago.PlanUpdateInputPlanCharges do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          applied_pricing_unit: Lago.PlanUpdateInputPlanChargesAppliedPricingUnit.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      applied_pricing_unit: {Lago.PlanUpdateInputPlanChargesAppliedPricingUnit, :t},
