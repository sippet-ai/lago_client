defmodule Lago.OrganizationUpdateInputOrganization do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          billing_configuration: Lago.OrganizationBillingConfiguration.t() | nil,
          city: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      billing_configuration: {Lago.OrganizationBillingConfiguration, :t},
